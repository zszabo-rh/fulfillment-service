...
type ClusterStatus struct {
	...
	State ClusterState `protobuf:"varint,1,opt,name=state,proto3,enum=osac.public.v1.ClusterState" json:"state,omitempty"`
...
type ClusterCondition struct {
	...
	Type ClusterConditionType `protobuf:"varint,1,opt,name=type,proto3,enum=osac.public.v1.ClusterConditionType" json:"type,omitempty"`
